...
public final class GrundrissControl {
	...
	public GrundrissControl() {
		...
		// -> grundrissControl ruft grundrissView's updateCheckboxen auf (Checkboxen
		// sind private)
	}
	...
	public void speichereSonderwuensche(int[] grundrissSw) {
		...
		if (this.pruefeKonstellationSonderwuensche(zuPruefendeSwKonstellation)) {
			try {
				...
				System.out.println(
						"Neue Auswahl an Sonderwünschen zu Grundriss-Varianten" + " konnte nicht gespeichert werden");
				exc.printStackTrace();
			}
		}
	}
