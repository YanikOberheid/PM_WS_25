...
public final class FensterControl {
	...
	private static final Map<Integer, Integer> PREISE = Map.of(301, 590, // 3.1 Schiebetüren EG
	...
	/**
	 * Platzhalter für spätere fachliche Prüfungen der Kombinationen. Aktuell immer
	 * true (gemäß Taskbeschreibung), Oberfläche für Konflikte folgt in einem
	 * späteren Task.
	 */
