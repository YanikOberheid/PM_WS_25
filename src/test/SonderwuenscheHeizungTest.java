...
/**
 * JUnit-Tests für die Heizungs-Sonderwünsche (Kategorie 50). Entspricht Task
 * [3]: "Ausgewählte Sonderwünsche zu Heizkörpern anzeigen".
 */
public class SonderwuenscheHeizungTest {
	...
	/**
	 * Testet, ob ein gespeicherter Heizungs-Sonderwunsch über dao.get(hausnr)
	 * korrekt wieder geladen wird.
	 */
	@Test
	...
	/**
	 * Testet die Variante mit Kategorie-Filter: dao.get(hausnr, 50) soll nur
	 * Heizungs-Sonderwünsche liefern.
	 */
	@Test
